...
ENDPOINT_NAME = os.getenv("SAGEMAKER_ENDPOINT_NAME", "urban-green-score-endpoint")

IMAGE_PATH = "data/raw/test/Rural/images_png/4196.png"
OUTPUT_DIR = "artifacts/predictions"

OUTPUT_JSON_PATH = os.path.join(OUTPUT_DIR, "endpoint_response.json")
OUTPUT_MASK_RAW_PATH = os.path.join(OUTPUT_DIR, "endpoint_mask_raw.png")
OUTPUT_VISUALIZATION_PATH = os.path.join(OUTPUT_DIR, "endpoint_prediction.png")
...
def save_prediction_visualization(image_path, pred_mask, green_score, output_path):
    ...
    # Resize image to mask size for side-by-side display
...
if mask_base64:
    ...
    print("\nNo mask_png_base64 found in endpoint response.")